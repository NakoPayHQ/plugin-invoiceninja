...
{
    private const API_BASE = 'https://api.nakopay.com/v1';
    private const API_BASE_FALLBACK = 'https://daslrxpkbkqrbnjwouiq.supabase.co/functions/v1';
    ...
    private function request(string $method, string $path, ?array $data = null): array
    {
        $headers = [
            ...
            'User-Agent' => 'nakopay-invoiceninja/' . self::PLUGIN_VERSION,
